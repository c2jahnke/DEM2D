function DEM2Dplot(data,par)
    ...
    if(par.toolBool)
        plot([data.toolbBox(1) data.toolbBox(1) data.toolbBox(1) data.toolbBox(2) data.toolbBox(2) data.toolbBox(1)],...
         [data.toolbBox(3) data.toolbBox(4) data.toolbBox(3) data.toolbBox(3) data.toolbBox(4) data.toolbBox(4)],'r-','LineWidth',2)
     end
